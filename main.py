...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.sidebar_frame = customtkinter.CTkFrame(self, width=140, height=400, corner_radius=0)
        ...
        self.sidebar_button_1 = customtkinter.CTkButton(self.sidebar_frame, command=autofill(firstName, lastName,phone, email,street1, street2, city, state, zip, dob, ssn), text='Submit')
